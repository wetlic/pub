...
def parse_asa_show_context(raw_output, relative_path=None):
    """
    parse output from "show context"
    :param raw_output: string
    :param relative_path: string with path to the git repository, e.g. python_network_tools/
    :rtype: list of lists, first element is field desription
    """
    return __parse_with_template(raw_output, "parser_templates/asa_show_context.textfsm", relative_path)


def parse_asa_show_route(raw_output, relative_path=None):
    """
    parse output from "show route"
    :param raw_output: string
    :param relative_path: string with path to the git repository, e.g. python_network_tools/
    :rtype: list of lists, first element is field desription
    """
    return __parse_with_template(raw_output, "ntc-templates/templates/cisco_asa_show_route.textfsm", relative_path)
